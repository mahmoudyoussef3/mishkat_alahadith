...
class DailyZekrDecorations {
  ...
  static BoxDecoration zekrCard({required bool enabled, required bool checked}) {
    final bgColor = checked
        ? ColorsManager.primaryPurple.withOpacity(0.06)
        : ColorsManager.cardBackground;
    final borderColor = checked ? ColorsManager.primaryPurple : ColorsManager.mediumGray;
  ...
  static BoxDecoration footerPill({required bool enabled, required bool checked}) {
  ...
  static BoxDecoration personalTaskTile({required bool isDone}) => BoxDecoration(
        color: isDone
            ? ColorsManager.primaryPurple.withOpacity(0.06)
