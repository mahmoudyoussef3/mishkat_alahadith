...
class PrayerTimesTextStyles {
  ...
  static TextStyle sectionHeaderLabel = BaseStyles.TextStyles.headlineMedium.copyWith(
    color: ColorsManager.primaryText,
    fontWeight: FontWeight.bold,
  );

  // Next prayer small label ("الصلاة القادمة")
  static TextStyle nextPrayerSectionLabel = BaseStyles.TextStyles.bodyMedium.copyWith(
    color: ColorsManager.secondaryText,
    fontWeight: FontWeight.w600,
  );

  // Next prayer name (e.g., "العصر")
  static TextStyle nextPrayerNameLabel = BaseStyles.TextStyles.headlineSmall.copyWith(
    color: ColorsManager.primaryText,
    fontWeight: FontWeight.bold,
  );

  // Next prayer time value (HH:MM)
  static TextStyle nextPrayerTimeValue = BaseStyles.TextStyles.titleLarge.copyWith(
